...
def play_hand(hand, word_list):
    ...
    * The final score is displayed.
    ...
    """
    # TO DO ...
    def getScore(hand, totalScore, word_list): #Recursive function that helps count score  
        while True:
            if len(hand) == 0:
                return 0
            print "Your hand is: "
            ...
            if is_valid_word(word, hand, word_list):
                ...
                print "The word \"", word, "\" IS IN A LIST! Score = ",get_word_score(word,n)
                print "YOUR NEW SCORE IS: ", totalScore
...
#play_hand(deal_hand(7),load_words()) #TEST
